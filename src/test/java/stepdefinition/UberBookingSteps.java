...
public class UberBookingSteps {
		...
		@When("User select car {string} and pick up point {string} and drop lacation {string}")
		public void user_select_car_and_pick_up_point_and_drop_lacation(String carType, String pickUpLocation, String dropLocation) {
